...
export class LanimalComponent implements OnInit {
  ...
  public model1 : Animal ={ id_animal:0, nombre:'',n_microchip:'', dueno_id_dueno_id:0, 
  color_id_color_id:0 ,especie_id_especie_id:0, estado_id_estado_id:0,sexo_id_sexo_id:0 }

  public model2 : ConsultaReserva={ id_consulta_reserva:0, fecha:'',motivo_consulta:'',peso:0,
  reserva_horas_id_reserva_horas_id:0,animal_id_animal_id:0 }

  public model3 : ConsuProcedimiento={id_consulta_procedimiento:0, observaciones:'', emp_id_emp_id:0, procedimiento_id_procedimiento_id:0,
